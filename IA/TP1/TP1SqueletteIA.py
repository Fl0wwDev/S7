...
class Node:
    ...
    def __init__(self, cost, town, parent=None, road_to_parent=None):
        self.cost = cost
        self.town = town
        self.parent = parent
...
def get_distance(town1, town2):
    for road in roads:
        if (road.town1.dept_id == town1 and road.town2.dept_id == town2) or (road.town1.dept_id == town2 and road.town2.dept_id == town1):
