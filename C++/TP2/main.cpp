...
int main() {
    ...
    KNN knn_1(1, "dtw");
    cout << "KNN (k=1, DTW) accuracy: " << knn_1.evaluate(trainData, testData, ground_truth) << endl;

    KNN knn_2(2, "euclidean_distance");
    cout << "KNN (k=2, Euclidean) accuracy: " << knn_2.evaluate(trainData, testData, ground_truth) << endl;

    KNN knn_3(3, "euclidean_distance");
    cout << "KNN (k=3, Euclidean) accuracy: " << knn_3.evaluate(trainData, testData, ground_truth) << endl;
